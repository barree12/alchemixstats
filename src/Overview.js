...
export default class Overview extends React.Component { 
    ...
    render(){
        let alUsdLiquidity = this.props.lpsLoading ? 0 : Math.round(this.props.lps.alUsdIn3Crv/10000 + this.props.lps.crv3In3Crv/10000 + this.props.lps.alUsdInVelodrome/10000 + this.props.lps.usdcInVelodrome/10000 + this.props.lps.alUsdInCurveDola/10000 + this.props.lps.sdolaInCurveDola/10000 + this.props.lps.alUsdInVeloDolaAlUsd/10000 + this.props.lps.dolaInVeloDolaAlUsd/10000 + this.props.lps.alUsdInCurveFrxUsd/10000 + this.props.lps.frxUsdInCurveFrxUsd/10000 + this.props.lps.alUsdInArbiUsdc/10000 + this.props.lps.usdcInArbiUsdc/10000 + this.props.lps.alUsdInUsdcCurve/10000 + this.props.lps.usdcInUsdcCurve/10000)/100;
        let alEthLiquidity = (this.props.lpsLoading || this.props.tokenPricesLoading) ? 0 : Math.round((this.props.lps.alEthInAlEthWethCrv + this.props.lps.alEthInSaddle + this.props.lps.wethInAlEthWethCrv + this.props.lps.wethInSaddle + this.props.lps.sEthInSaddle + this.props.lps.alEthInVelodrome + this.props.lps.wethInVelodrome + this.props.lps.alEthInFrxEthCrv + this.props.lps.frxEthInFrxEthCrv + this.props.lps.pxEthInVeloAlEth + this.props.lps.alEthInVeloAlEth + this.props.lps.alEthInArbiWeth + this.props.lps.wethInArbiWeth)*this.props.ethPrice/10000)/100;
            ...
            <>
                ...
                <div className="overview">
                    ...
                    <span>
                        ...
                        Octav dashboards are also available in addition to this UI, you can find all of the URLs under the Holdings tab below.<br/>
