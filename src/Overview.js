                    ...
                    <div className="tvl-tables-3">
                        ...
                        <div className="small-table-4">
                            ...
                            {/*<div className="small-table-inner-10">
                                ...
                                <span className="small-table-content-wrap"><span className="table-text-bold">${Math.round(this.props.ethPrice*100)/100}</span><span className="table-text-bold">${Math.round(this.props.ethPrice*100)/100}</span><span className="change-wrapper">{ethPriceChange >= 0 ? <span className="change-positive">+{ethPriceChange}%</span> : <span className="change-negative">{ethPriceChange}%</span>}</span></span>
                            ...
                            <div className="small-table-inner-9">
                                <span className="small-table-row"><img src={ require('./logos/dai.png').default } alt="dai logo" className="image" /></span><span className="table-text-title">Stable Vaults</span><span className="important-2">${stablecoinDeposits}M</span>
                                <span className="small-table-row"><img src={ require('./logos/eth.png').default } alt="eth logo" className="image" /></span><span className="table-text-title">ETH Vaults</span><span className="important-2">{ethDeposits} ETH</span>
                                ...
                                <span className="small-table-row"></span><span className="table-text-title">ETH Vaults ($)</span><span className="important-2">${ethDepositsUsd}M</span>
                                <span className="small-table-row"></span><span className="important-4"></span><span className="table-text-bold"></span>
