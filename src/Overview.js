...
//console.log(this.props.vaultV1Tvls)
        ...
        let ethDeposits = this.props.v2CurrentLoading ? 0 : Math.round(this.props.v2Deposit.wethInMigrate + this.props.v2EthTVL + this.props.v2aWethTVL + this.props.v2StethTVL + this.props.v2RethTVL + this.props.v2vaEthTVL);
        let ethDepositsUsd = Math.round((this.props.wethInMigrateUsd + this.props.v2EthUsdTVL + this.props.v2aWethUsdTVL + this.props.v2StethUsdTVL + this.props.v2RethUsdTVL + this.props.v2vaEthUsdTVL)*100)/100;
        ...
        let ethDeposits1mAgo = (this.props.alchemistTvlLoading || this.props.v2CurrentLoading) ? 0 : Math.round(this.props.v2Deposit.wethInMigrate + this.props.alchemistTvl.yvWeth[this.props.alchemistTvl.yvWeth.length-31] + this.props.alchemistTvl.aWeth[this.props.alchemistTvl.aWeth.length-31] + this.props.alchemistTvl.wstEth[this.props.alchemistTvl.wstEth.length-31] + this.props.alchemistTvl.rEth[this.props.alchemistTvl.rEth.length-31]);
