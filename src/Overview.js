...
//console.log(this.props.vaultV1Tvls)
        ...
        let ethDepositsUsd = Math.round((this.props.wethInMigrateUsd + this.props.v2EthUsdTVL + this.props.v2aWethUsdTVL + this.props.v2StethUsdTVL + this.props.v2RethUsdTVL)*100)/100;
        let deposits = Math.round((stablecoinDeposits + ethDepositsUsd)*100)/100;
        let stablecoinDeposits1mAgo = (this.props.vaultTvlsLoading || this.props.alchemistTvlLoading || this.props.v2CurrentLoading) ? 0 : Math.round((this.props.v2Deposit.daiInMigrate + this.props.alchemistTvl.yvDai[this.props.alchemistTvl.yvDai.length-31] + this.props.alchemistTvl.yvUsdc[this.props.alchemistTvl.yvUsdc.length-31] + this.props.alchemistTvl.yvUsdt[this.props.alchemistTvl.yvUsdt.length-31] + this.props.alchemistTvl.aDai[this.props.alchemistTvl.aDai.length-31] + this.props.alchemistTvl.aUsdc[this.props.alchemistTvl.aUsdc.length-31] + this.props.alchemistTvl.aUsdt[this.props.alchemistTvl.aUsdt.length-31])*100)/100;
        let ethDeposits1mAgo = (this.props.vaultTvlsLoading || this.props.alchemistTvlLoading || this.props.v2CurrentLoading) ? 0 : Math.round(this.props.v2Deposit.wethInMigrate + this.props.alchemistTvl.yvWeth[this.props.alchemistTvl.yvWeth.length-31] + this.props.alchemistTvl.aWeth[this.props.alchemistTvl.aWeth.length-31] + this.props.alchemistTvl.wstEth[this.props.alchemistTvl.wstEth.length-31] + this.props.alchemistTvl.rEth[this.props.alchemistTvl.rEth.length-31]);
        ...
        return (
            <>
                ...
                <div className="overview">
                    ...
                    {(this.props.vaultTvlsLoading || this.props.tokenPricesLoading || this.props.alUsdPegLoading || this.props.alEthPegLoading || this.props.alchemistTvlLoading || this.props.v2CurrentLoading) ? <LoadingComponent /> :
