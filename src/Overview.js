...
//console.log(this.props.vaultV1Tvls)
        ...
        let alEthLiquidity = this.props.lpsLoading ? 0 : Math.round((this.props.lps.alEthInCrv + this.props.lps.alEthInSaddle + this.props.lps.ethInAlEthCrv + this.props.lps.wethInSaddle + this.props.lps.sEthInSaddle + this.props.lps.alEthInVelodrome + this.props.lps.wethInVelodrome)*this.props.ethPrice[this.props.ethPrice.length-1]/10000)/100;
