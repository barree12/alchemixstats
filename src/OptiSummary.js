          ...
          <>
            <div className="summary">
                <div className="small-table">
                    ...
                    <span className="small-table-row"><img src={ require('./logos/eth.png').default } alt="ETH logo" className="image" />yvWETH</span><span className="important-4"><span>${this.props.optiYvWethUsdTVL}M</span><i>({this.props.optiYvWethTVL} ETH)</i></span><span className="table-text-bold"></span>
