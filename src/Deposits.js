                ...
                <div className="summary">
                        ...
                        *Please note that the deposit caps are set in USD and ETH, not the token of the underlying vault.<br/>
                        ...
                        <div className="small-table">
                            ...
                            <span className="small-table-row"><img src={ require('./logos/aave_usdc.png').default } alt="Vesper USDC logo" className="image" />vaUSDC</span><span className="important-2">${this.props.v2vaUsdcTVL}M</span><span className="table-text-bold">${Math.round(this.props.v2Caps.vaUsdc/10000)/100}M</span>
                            <span className="small-table-row"><img src={ require('./logos/aave_usdc.png').default } alt="Vesper Dai logo" className="image" />vaDAI</span><span className="important-2">${this.props.v2vaDaiTVL}M</span><span className="table-text-bold">${Math.round(this.props.v2Caps.vaDai/10000)/100}M</span>
                            ...
                            <span className="small-table-row"><img src={ require('./logos/reth.png').default } alt="rETH logo" className="image" />vaETH</span><span className="important-4">${this.props.v2vaEthUsdTVL}M&nbsp;<i>({this.props.v2vaEthTVL} ETH)</i></span><span className="table-text-bold">{Math.round(this.props.v2Caps.vaEth)} ETH</span>
