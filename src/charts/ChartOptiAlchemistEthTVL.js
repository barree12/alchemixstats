...
export default class ChartOptiAlchemistEthTVL extends React.Component {

  saveCanvas() {
      //save to png
      const canvasSave = document.getElementById('optiAlchemistEthTvl');
      canvasSave.toBlob(function (blob) {
        saveAs(blob, "opti_alchemist_eth_tvl.png")
      })
  }
