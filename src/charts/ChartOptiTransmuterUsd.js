...
export default class ChartOptiTransmuterUsd extends React.Component {

  saveCanvas() {
      //save to png
      const canvasSave = document.getElementById('optiTransmuterUsd');
      canvasSave.toBlob(function (blob) {
        saveAs(blob, "opti_transmuter_usd.png")
      })
  }
